...
public class MemberRegisterService {
	...
	public Long register(RegisterCommand registerCommand) {
		...
		if(member!=null) throw new DuplicateMemberException("중복된 이메일 입니다 : " + registerCommand.getEmail());
		// insert메서드 호출
		Member newMember = new Member(registerCommand.getEmail(), registerCommand.getPassword(),
				registerCommand.getName(), LocalDateTime.now());
